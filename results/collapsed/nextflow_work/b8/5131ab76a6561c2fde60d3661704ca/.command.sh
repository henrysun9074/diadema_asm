#!/usr/bin/env python3
import os
fd = open('locustypes.tsv')
lines = fd.read().splitlines()
seq_id_to_transcriptID = {}

locus_tag_prefix = 'DANT' or 'egapxtmp'
...
replace_identifier(seq_id_to_transcriptID, "gnomon_report.txt")
replace_identifier(seq_id_to_transcriptID, "gnomon_quality_report.txt")
