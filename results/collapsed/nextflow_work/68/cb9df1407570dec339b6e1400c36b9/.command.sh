...
echo "Assembly: DO2_collapsed_polished sampleID: SRR24973327 Query: SRR24973327_1.fasta"
...
echo "<job query =\"lcl|SRR24973327_1.fasta\" subject=\"DO2_collapsed_polished.index\"></job>" > jobfile
star=$(which star-with-filter)
samtools=$(which samtools)
fastq=$(which fasterq-dump)
seqkit=$(which seqkit)
echo SRR24973327_1.fasta; zstdcat SRR24973327_1.fasta | seqkit stats
