...
echo "Assembly: DO2_hap1 sampleID: SRR29948272 Query: SRR29948272_1.fasta,SRR29948272_2.fasta"
    ...
    echo "<job query =\"lcl|SRR29948272_1.fasta,SRR29948272_2.fasta\" subject=\"DO2_hap1.index\"></job>" > jobfile
